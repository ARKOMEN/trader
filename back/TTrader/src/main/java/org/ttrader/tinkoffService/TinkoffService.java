...
public class TinkoffService extends Endpoint {
    ...
    private static final FigiDescriptor[] figiDescriptors = {
        ...
        new FigiDescriptor("BBG004S68758", "BANE"),//6
        /*BANEP
        "figi": "BBG004S686N0", "classCode": "TQBR", "uid": "a5776620-1e2f-47ea-bbd6-06d8e4a236d8",*/
        //new FigiDescriptor("BBG004S686N0", "BANEP"),//7
        /*PIKK
        ...
        //new FigiDescriptor("BBG00Z197548", "BSPBP"),//8
        /*JETL
        ...
        new FigiDescriptor("BBG004RVFCY3", "MGNT"),//12
        /*MGNT@GS
        ...
        //new FigiDescriptor("BBG000FJ6S03", "VGSBP"),//13
        /*NLMK
        ...
        //new FigiDescriptor("BBG004S681B4", "NLMK"),//14
        /*NLMK@GS
        ...
        //new FigiDescriptor("TCS00A108GD8", "IVAT"),//15
        /*MVID
        ...
        //new FigiDescriptor("BBG004S68CP5", "MVID"),//16
        /*GAZP
        ...
        //new FigiDescriptor("BBG004730RP0", "GAZP"),//17
    };
    ...
    public void onMessage(String message) {
        ...
        try{
            ...
            JsonNode node2 = node1.get("price");
            double price = (double)Integer.parseInt(node2.get("units").asText()) + ((double)node2.get("nano").asInt())/unitsToNanos;
